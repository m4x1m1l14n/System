		...
		if (iter != formats.end())
		{
			...
			do
			{
				len = _snwprintf(buffer, len, iter->second.c_str(),
					static_cast<unsigned char>(reinterpret_cast<const unsigned char*>(&m_guid.Data1)[0]),
					static_cast<unsigned char>(reinterpret_cast<const unsigned char*>(&m_guid.Data1)[1]),
					static_cast<unsigned char>(reinterpret_cast<const unsigned char*>(&m_guid.Data1)[2]),
					static_cast<unsigned char>(reinterpret_cast<const unsigned char*>(&m_guid.Data1)[3]),
					static_cast<unsigned char>(reinterpret_cast<const unsigned char*>(&m_guid.Data2)[0]),
					static_cast<unsigned char>(reinterpret_cast<const unsigned char*>(&m_guid.Data2)[1]),
					static_cast<unsigned char>(reinterpret_cast<const unsigned char*>(&m_guid.Data3)[0]),
					static_cast<unsigned char>(reinterpret_cast<const unsigned char*>(&m_guid.Data3)[1]),
					m_guid.Data4[0],
					m_guid.Data4[1],
					m_guid.Data4[2],
					m_guid.Data4[3],
